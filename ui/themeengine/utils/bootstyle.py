...
class Bootstyle:
    ...
    def setup_ttktheming_api() -> None:
        ...
        from ui.themeengine.builders.constants import TTK_WIDGETS  # Widgets de ttk (Button, Entry, etc.) 19
        from ui.themeengine.builders.constants import TK_WIDGETS  # Widgets de tk estándar (Label, Frame, etc.) 17
